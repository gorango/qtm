...
use strategies_core::ZScoreConfig;
...
pub fn z_score_breakout_strategy(
	...
	strategies_core::z_score_breakout_strategy(&closes, config)
		.map_err(|e| napi::Error::new(napi::Status::InvalidArg, e.to_string()))
}

pub fn z_score_breakout_strategy_metadata() -> serde_json::Value {
	strategies_core::z_score_breakout_strategy_metadata()
}

pub fn z_score_breakout_strategy_defaults() -> serde_json::Value {
	strategies_core::z_score_breakout_strategy_defaults()
}
...
pub fn z_score_breakout(
	...
	strategies_core::z_score_breakout_strategy(&input.closes, config)
		.map_err(|e| napi::Error::new(napi::Status::InvalidArg, e.to_string()))
}
