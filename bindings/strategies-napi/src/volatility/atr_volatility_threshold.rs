...
use strategies_core::AtrVolatilityThresholdConfig;
...
pub fn atr_volatility_threshold_strategy_metadata() -> serde_json::Value {
	strategies_core::atr_volatility_threshold_strategy_metadata()
}

pub fn atr_volatility_threshold_strategy_defaults() -> serde_json::Value {
	strategies_core::atr_volatility_threshold_strategy_defaults()
}
...
pub fn atr_volatility_threshold(
	...
	strategies_core::atr_volatility_threshold_strategy(
