...
use strategies_core::KeltnerVolatilityBreakoutConfig;
...
pub fn keltner_volatility_breakout_strategy(
	...
	strategies_core::keltner_volatility_breakout_strategy(&highs, &lows, &closes, config)
		.map_err(|e| napi::Error::new(napi::Status::InvalidArg, e))
}

pub fn keltner_volatility_breakout_strategy_metadata() -> serde_json::Value {
	strategies_core::keltner_volatility_breakout_strategy_metadata()
}

pub fn keltner_volatility_breakout_strategy_defaults() -> serde_json::Value {
	strategies_core::keltner_volatility_breakout_strategy_defaults()
}
...
pub fn keltner_volatility_breakout(
	...
	strategies_core::keltner_volatility_breakout_strategy(
