...
use strategies_core::WilliamsRConfig;
...
pub fn williams_r_strategy(
	...
	strategies_core::williams_r_strategy(&highs, &lows, &closes, config)
		.map_err(|e| napi::Error::new(napi::Status::InvalidArg, e.to_string()))
}

pub fn williams_r_strategy_metadata() -> serde_json::Value {
	strategies_core::williams_r_strategy_metadata()
}

pub fn williams_r_strategy_defaults() -> serde_json::Value {
	strategies_core::williams_r_strategy_defaults()
}
...
pub fn williams_r(
	...
	strategies_core::williams_r_strategy(
