...
use strategies_core::AdxRsiConfig;
...
pub fn adx_rsi_strategy(
	...
	strategies_core::adx_rsi_strategy(&highs, &lows, &closes, config)
		.map_err(|e| napi::Error::new(napi::Status::InvalidArg, e))
}

pub fn adx_rsi_strategy_metadata() -> serde_json::Value {
	strategies_core::adx_rsi_strategy_metadata()
}

pub fn adx_rsi_strategy_defaults() -> serde_json::Value {
	strategies_core::adx_rsi_strategy_defaults()
}
...
pub fn adx_rsi(
	...
	strategies_core::adx_rsi_strategy(
