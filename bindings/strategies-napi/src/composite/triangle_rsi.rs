...
use strategies_core::TriangleRsiConfig;
...
pub fn triangle_rsi_strategy(
	...
	strategies_core::triangle_rsi_strategy(&highs, &lows, &closes, config)
		.map_err(|e| napi::Error::new(napi::Status::InvalidArg, e.to_string()))
}

pub fn triangle_rsi_strategy_metadata() -> serde_json::Value {
	strategies_core::triangle_rsi_strategy_metadata()
}

pub fn triangle_rsi_strategy_defaults() -> serde_json::Value {
	strategies_core::triangle_rsi_strategy_defaults()
}
...
pub fn triangle_rsi(
	...
	strategies_core::triangle_rsi_strategy(
