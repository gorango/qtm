...
use strategies_core::VwapMacdConfig;
...
pub fn vwap_macd_strategy(
	...
	strategies_core::vwap_macd_strategy(&highs, &lows, &closes, &volumes, config)
		.map_err(|e| napi::Error::new(napi::Status::InvalidArg, e.to_string()))
}

pub fn vwap_macd_strategy_metadata() -> serde_json::Value {
	strategies_core::vwap_macd_strategy_metadata()
}

pub fn vwap_macd_strategy_defaults() -> serde_json::Value {
	strategies_core::vwap_macd_strategy_defaults()
}
...
pub fn vwap_macd(
	...
	strategies_core::vwap_macd_strategy(
