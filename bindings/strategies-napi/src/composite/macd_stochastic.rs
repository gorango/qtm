...
use strategies_core::MacdStochasticConfig;
...
pub fn macd_stochastic_strategy_metadata() -> serde_json::Value {
	strategies_core::macd_stochastic_strategy_metadata()
}

pub fn macd_stochastic_strategy_defaults() -> serde_json::Value {
	strategies_core::macd_stochastic_strategy_defaults()
}
...
pub fn macd_stochastic(
	...
	strategies_core::macd_stochastic_strategy(
