...
use strategies_core::VwapRsiConfig;
...
pub fn vwap_rsi_strategy(
	...
	strategies_core::vwap_rsi_strategy(&highs, &lows, &closes, &volumes, config)
		.map_err(|e| napi::Error::new(napi::Status::InvalidArg, e.to_string()))
}

pub fn vwap_rsi_strategy_metadata() -> serde_json::Value {
	strategies_core::vwap_rsi_strategy_metadata()
}

pub fn vwap_rsi_strategy_defaults() -> serde_json::Value {
	strategies_core::vwap_rsi_strategy_defaults()
}
...
pub fn vwap_rsi(
	...
	strategies_core::vwap_rsi_strategy(
