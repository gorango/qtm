...
use strategies_core::SuperTrendConfig;
...
pub fn super_trend_strategy_metadata() -> serde_json::Value {
	strategies_core::super_trend_strategy_metadata()
}

pub fn super_trend_strategy_defaults() -> serde_json::Value {
	strategies_core::super_trend_strategy_defaults()
}
...
pub fn super_trend(
	...
	strategies_core::super_trend_strategy(
