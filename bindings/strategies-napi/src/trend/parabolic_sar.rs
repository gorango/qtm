...
use strategies_core::ParabolicSarConfig;
...
pub fn parabolic_sar_strategy(
	...
	strategies_core::parabolic_sar_strategy(&highs, &lows, &closes, config)
		.map_err(|e| napi::Error::new(napi::Status::InvalidArg, e.to_string()))
}

pub fn parabolic_sar_strategy_metadata() -> serde_json::Value {
	strategies_core::parabolic_sar_strategy_metadata()
}

pub fn parabolic_sar_strategy_defaults() -> serde_json::Value {
	strategies_core::parabolic_sar_strategy_defaults()
}
...
pub fn parabolic_sar(
	...
	strategies_core::parabolic_sar_strategy(
