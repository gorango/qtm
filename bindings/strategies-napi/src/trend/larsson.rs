...
use strategies_core::LarssonConfig;
...
pub fn larsson_strategy(
	...
	strategies_core::larsson_strategy(&highs, &lows, &closes, config)
		.map_err(|e| napi::Error::new(napi::Status::InvalidArg, e))
}

pub fn larsson_strategy_metadata() -> serde_json::Value {
	strategies_core::larsson_strategy_metadata()
}

pub fn larsson_strategy_defaults() -> serde_json::Value {
	strategies_core::larsson_strategy_defaults()
}
...
pub fn larsson(
	...
	strategies_core::larsson_strategy(
