...
pub fn adx_strategy(
	...
	strategies_core::adx_strategy(&highs, &lows, &closes, config)
		.map_err(|e| napi::Error::new(napi::Status::InvalidArg, e))
}

pub fn adx_strategy_metadata() -> serde_json::Value {
	strategies_core::adx_strategy_metadata()
}

pub fn adx_strategy_defaults() -> serde_json::Value {
	strategies_core::adx_strategy_defaults()
}
