...
use strategies_core::VortexConfig;
...
pub fn vortex_strategy(
	...
	strategies_core::vortex_strategy(&highs, &lows, &closes, config)
		.map_err(|e| napi::Error::new(napi::Status::InvalidArg, e.to_string()))
}

pub fn vortex_strategy_metadata() -> serde_json::Value {
	strategies_core::vortex_strategy_metadata()
}

pub fn vortex_strategy_defaults() -> serde_json::Value {
	strategies_core::vortex_strategy_defaults()
}
...
pub fn vortex(
	...
	strategies_core::vortex_strategy(
