...
use strategies_core::AlmacrossoverConfig;
...
pub fn alma_crossover_strategy(
	...
	strategies_core::alma_crossover_strategy(&closes, config)
		.map_err(|e| napi::Error::new(napi::Status::InvalidArg, e.to_string()))
}

pub fn alma_crossover_strategy_metadata() -> serde_json::Value {
	strategies_core::alma_crossover_strategy_metadata()
}

pub fn alma_crossover_strategy_defaults() -> serde_json::Value {
	strategies_core::alma_crossover_strategy_defaults()
}
...
pub fn alma_crossover(
	...
	strategies_core::alma_crossover_strategy(&input.closes, config)
		.map_err(|e| napi::Error::new(napi::Status::InvalidArg, e.to_string()))
}
