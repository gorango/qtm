...
/// Rolling minimum with growing window (window size starts at 1 and grows until it reaches period)
#[allow(dead_code)]
...
/// Rolling maximum with growing window (window size starts at 1 and grows until it reaches period)
#[allow(dead_code)]
